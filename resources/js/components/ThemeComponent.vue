<template>
    <div>
        <div v-if="!editProfile" class="mb-3 d-flex justify-content-end">
            <button @click="showTheme"  type="button" class="btn btn-outline-info mr-3">
            ...
            <button @click="createTheme" type="button" class="btn btn-outline-success">
        ...
        <div v-if="editProfile" class="mb-2 d-flex justify-content-end">
            <button @click="undoEditTheme" type="button" class="btn btn-outline-dark mr-1">
