                ...
                <div class="d-flex">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div v-if="urlPicture" class="d-flex justify-content-left align-items-center mb-3">
                            ...
                            <div class="d-flex justify-content-around align-items-center mt-3">
                                <button @click="add()" data-toggle="tooltip" data-placement="left" title="Добавьте ссылку" type="submit" class="justify-content-end btn btn-success">Добавить</button>
                            </div>
                        </div>
                    </div>
                </div>
