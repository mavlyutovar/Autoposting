        ...
        <div class="col-7 col-lg-7">
            <div class="card mb-4" style="margin: auto;">
                ...
                <div class="card-body">
                    ...
                    <h6 class="mb-3">Перед сохранением набора добавьте несколько сообщений одной тематики ниже.</h6>
                    ...
                    <div class="d-flex justify-content-around align-items-center mt-3 mb-3">
                        <button @click="add()" data-toggle="tooltip" data-placement="left" title="Добавьте несколько сообщений одной тематики" type="submit" class="justify-content-end btn btn-success">Добавить сообщение</button>
                    </div>
                ...
                <div class="card-body">
                    <ul class="list-group">
                        <li v-for="(item, index) in listCases" class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <button @click="editText(index, item.id)" type="button" class="btn btn-success mr-2">
